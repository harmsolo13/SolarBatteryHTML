#!/usr/bin/env python3
"""
Create Home Assistant BOM Integration for Battery Calculator
Uses HA REST API to fetch weather data from BOM integration
"""
...
const HA_CONFIG = {
  ...
  // Weather entity ID (e.g., 'weather.bom_adelaide')
  weatherEntity: 'weather.bom_adelaide', // UPDATE THIS with your entity ID
...
function convertHAForecastToBatteryPrediction(haForecast, avgSolarPerDay) {
  ...
  for (let i = 0; i < Math.min(haForecast.forecast.length, 7); i++) {
    ...
    const maxSOC = Math.min(startingSOC + solarToBuffer, batteryCapacity);
...
print("=" * 80)
print("Creating Home Assistant BOM Integration")
print("=" * 80)
print()

# Save the integration code
with open('ha_bom_integration.js', 'w') as f:
    f.write(HA_INTEGRATION_JS)

print("[OK] Created ha_bom_integration.js")
print()
print("This JavaScript code will:")
print("  1. Connect to Home Assistant at 192.168.68.60:8123")
print("  2. Request access token from user (one-time per session)")
print("  3. Fetch BOM weather forecast from HA weather entity")
print("  4. Parse forecast data and map conditions to solar multipliers")
print("  5. Predict battery SOC based on BOM weather")
print()
print("=" * 80)
print("Next Steps")
print("=" * 80)
print()
print("1. Find your weather entity ID in Home Assistant")
print("   (e.g., weather.bom_adelaide)")
print()
print("2. Update HA_CONFIG.weatherEntity in the code")
print()
print("3. Integrate into BatteryROI_7.html")
print()
print("4. Get Long-Lived Access Token from HA:")
print("   Settings → People → [Your Name] → Security")
